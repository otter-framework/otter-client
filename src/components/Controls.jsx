...
const Controls = ({ localStream, chatOpen, setChatOpen }) => {
  ...
  return (
    <div className="flex gap-3 py-3 justify-center backdrop-blur-lg w-[280px] rounded-full bg-white/30 place-self-center">
      <button
      ...
      <button
        onClick={closeTab}
        className={`inline-block hover:bg-red-700 bg-red-600 p-3 rounded-full transition-all ease-in-out duration-200`}
      >
        <svg
          viewBox="0 0 24 24"
          xmlns="http://www.w3.org/2000/svg"
